...
var Tamagotchi = {
  ...
  initialize: function (name, imageNumber, birthdate) {
    ...
    this.foodLevel = randomInteger(50, 100);
    this.happinessLevel = randomInteger(50, 100);
    this.restedLevel = randomInteger(50, 100);
    this.healthLevel = randomInteger(50, 100);
  },
...
// Time passes
  ...
  setTamagotchiMeters: function (intervalID) {
    ...
    if (!this.isAlive()) {
      ...
      $(".alert-msg").text("Your Tamagotchi is sick: Feed, play, Wash it!")
      ...
      $(".alert").addClass("alert-warning");
      $(".alert-msg").text("Your Tamagotchi is tired: Wash It!")
    };
  }
}; // end Tamagotchi
